...
async function handleNyxImageCommand(api, event) {
  ...
  api.sendMessage("🗨️ | 𝙽𝚢𝚡 𝙰𝙸 𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚗𝚐 𝚙𝚛𝚘𝚖𝚙𝚝, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...⚠️", event.threadID, event.messageID);
...
async function convertVoiceToText(audioUrl, api, event) {
  try {
    api.sendMessage("💽 | 𝙽𝚢𝚡 𝙰𝙸 𝙲𝚘𝚗𝚟𝚎𝚛𝚝𝚒𝚗𝚐 𝙰𝚞𝚍𝚒𝚘, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝...⚠️", event.threadID);
